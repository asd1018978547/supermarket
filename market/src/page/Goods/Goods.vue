  ...
  <div>
    ...
    <el-table :data="Goods" style="width: 100%" :loading="loading">
      ...
      <el-table-column label="管理">
        <template slot-scope="scope">
          <el-button type="text" size="small" @click="changeGoods(scope.row)">修改</el-button>
    ...
    <el-dialog title="编辑商品" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item label="条形码">
          <el-input disabled v-model="updataGoods.barCode"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    changeGoods(row) {
      ...
      this.changeType = require("../../json/type.json");
      console.log(row);
    },
    //确认修改
    updataGoodsBtn() {
